...
# Acknowledgement: Heavily inspired by torch.fx.symbolic_trace https://github.com/pytorch/pytorch/blob/main/torch/fx/_symbolic_trace.py
    ...
    **inputs: Any,
    ...
    if pf.context.globals.current_trace_level is not None:
        ...
        raise RuntimeError(
            ...
            "TODO this can be allowed fairly easily - contact the developers to request"
        )
