...
def align_euler_to_vector(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/align_euler_to_vector.html
    """
    return nt.ProcNode.from_nodetype(
...
def align_rotation_to_vector(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/align_rotation_to_vector.html
    """
    return nt.ProcNode.from_nodetype(
...
def axes_to_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/axes_to_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def axis_angle_to_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/axis_angle_to_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def boolean_not(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/boolean_not.html
    """
    return nt.ProcNode.from_nodetype(
        node_type="FunctionNodeBooleanMath",
        inputs={("Boolean", 0): a},
...
def combine_matrix(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/combine_matrix.html
    """
    return nt.ProcNode.from_nodetype(
...
def combine_transform(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/combine_transform.html
    """
    return nt.ProcNode.from_nodetype(
...
def _compare(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/compare.html
    """
...
def euler_to_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/euler_to_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def float_to_int(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/float_to_int.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_bool(boolean: bool = False) -> t.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_bool.html
    """
...
def input_color(value: tuple = (0.5, 0.5, 0.5, 1.0)) -> t.ProcNode[pt.Color]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_color.html
    """
...
def input_int(integer: int = 0) -> t.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_int.html
    """
...
def input_rotation(rotation_euler: tuple = (0.0, 0.0, 0.0)) -> t.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_rotation.html
    """
...
def input_special_characters() -> InputSpecialCharactersResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_special_characters.html
    """
    ...
    return InputSpecialCharactersResult(
        node.output_socket("line_break"), node.output_socket("tab")
    )
...
def input_string(string: str = "") -> nt.ProcNode[str]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_string.html
    """
...
def input_vector(vector: tuple = (0.0, 0.0, 0.0)) -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/input_vector.html
    """
...
def invert_matrix(matrix: nt.SocketOrVal[pt.Matrix] = None) -> InvertMatrixResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/invert_matrix.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InvertMatrixResult(
        node.output_socket("matrix"), node.output_socket("invertible")
    )
...
def invert_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/invert_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def matrix_multiply(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/matrix_multiply.html
    """
    return nt.ProcNode.from_nodetype(
...
def project_point(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/project_point.html
    """
    return nt.ProcNode.from_nodetype(
...
def quaternion_to_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/quaternion_to_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def replace_string(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/replace_string.html
    """
    return nt.ProcNode.from_nodetype(
...
def rotate_euler(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotate_euler.html
    """
    return nt.ProcNode.from_nodetype(
...
def rotate_rotation(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotate_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def rotate_vector(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotate_vector.html
    """
    return nt.ProcNode.from_nodetype(
...
def rotation_to_axis_angle(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotation_to_axis_angle.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return RotationToAxisAngleResult(
        node.output_socket("axis"), node.output_socket("angle")
    )
...
def rotation_to_euler(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotation_to_euler.html
    """
    return nt.ProcNode.from_nodetype(
...
def rotation_to_quaternion(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/rotation_to_quaternion.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return RotationToQuaternionResult(
        node.output_socket("w"),
        node.output_socket("x"),
        node.output_socket("y"),
        node.output_socket("z"),
    )
...
def separate_color(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/separate_color.html
    """
    ...
    return SeparateColorResult(
        red=res.output_socket("red"),
        green=res.output_socket("green"),
        blue=res.output_socket("blue"),
...
def separate_transform(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/separate_transform.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return SeparateTransformResult(
        node.output_socket("translation"),
        node.output_socket("rotation"),
...
def slice_string(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/slice_string.html
    """
    return nt.ProcNode.from_nodetype(
...
def string_length(string: nt.SocketOrVal[str] = "") -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/string_length.html
    """
    return nt.ProcNode.from_nodetype(
...
def transform_direction(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/transform_direction.html
    """
    return nt.ProcNode.from_nodetype(
...
def transform_point(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/transform_point.html
    """
    return nt.ProcNode.from_nodetype(
...
def transpose_matrix(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/transpose_matrix.html
    """
    return nt.ProcNode.from_nodetype(
...
def value_to_string(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/utilities/value_to_string.html
    """
    return nt.ProcNode.from_nodetype(
...
def rgb_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/input/rgb_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def combine_hsl(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/converter/combine_hsv.html
    """
    return nt.ProcNode.from_nodetype(
        node_type=ContextualNode.COMBINE_COLOR.value,
...
def separate_hsv(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/converter/separate_hsv.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return SeparateHsvResult(
        h=res.output_socket("h"),
        s=res.output_socket("s"),
        v=res.output_socket("v"),
    )
...
def separate_rgb(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/converter/separate_rgb.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return SeparateRgbResult(
        r=res.output_socket("r"),
        g=res.output_socket("g"),
        b=res.output_socket("b"),
    )
...
def separate_xyz(vector: nt.SocketOrVal[pt.Vector] = (0, 0, 0)) -> SeparateXyzResult:
    ...
    return SeparateXyzResult(
        node.output_socket("x"), node.output_socket("y"), node.output_socket("z")
    )
...
def vector_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/vector_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def index_switch(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/index_switch.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [
...
def switch(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/switch.html
    """
