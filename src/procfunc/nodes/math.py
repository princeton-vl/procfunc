...
Also hosts general-purpose value/color/vector utilities (mix, map_range,
combine/separate xyz/rgb/hsv/hsl, color_ramp, curves, constant) that work
across shader and geometry trees - they live here rather than in shader.py
or func.py to avoid implying they are tree-specific.
"""
