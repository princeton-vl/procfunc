...
def accumulate_field(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/accumulate_field.html
    """
    ...
    return AccumulateFieldResult(
        leading=res.output_socket("leading"),
        total=res.output_socket("total"),
        trailing=res.output_socket("trailing"),
    )
...
def attribute_domain_size(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/attribute/attribute_domain_size.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return AttributeDomainSizeResult(
        point_count=res.output_socket("point_count"),
        edge_count=res.output_socket("edge_count"),
        face_count=res.output_socket("face_count"),
        face_corner_count=res.output_socket("face_corner_count"),
        spline_count=res.output_socket("spline_count"),
        instance_count=res.output_socket("instance_count"),
    )
...
def attribute_statistic(
    ...
    return AttributeStatisticResult(
        max=res.output_socket("max"),
        mean=res.output_socket("mean"),
        median=res.output_socket("median"),
        min=res.output_socket("min"),
        range=res.output_socket("range"),
        standard_deviation=res.output_socket("standard_deviation"),
        sum=res.output_socket("sum"),
        variance=res.output_socket("variance"),
    )
...
def bound_box(geometry: nt.ProcNode[nt.Geometry]) -> BoundBoxResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/bound_box.html
    """
    ...
    return BoundBoxResult(
        node.output_socket("bounding_box"),
        node.output_socket("min"),
        node.output_socket("max"),
    )
...
def capture_attribute(
    ...
    **attributes: nt.SocketOrVal[TAttribute],
    ...
    return CaptureAttributeResult(
        geometry=res.output_socket("geometry"),
        attributes={k: res.output_socket(k) for k in attributes.keys()},
    )
...
def collection_info(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/collection_info.html
    """
    return nt.ProcNode.from_nodetype(
...
def convex_hull(geometry: nt.ProcNode[nt.Geometry]) -> nt.ProcNode[pt.MeshObject]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/convex_hull.html
    """
    return nt.ProcNode.from_nodetype(
...
def corners_of_edge(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/corners_of_edge.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return CornerResult(
        corner_index=res.output_socket("corner_index"),
        total=res.output_socket("total"),
    )
...
def corners_of_face(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/corners_of_face.html
    """
    res = nt.ProcNode.from_nodetype(
...
def corners_of_vertex(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/corners_of_vertex.html
    """
    res = nt.ProcNode.from_nodetype(
...
def curve_arc(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_arc.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_endpoint_selection(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/curve_endpoint_selection.html
    """
    return nt.ProcNode.from_nodetype(
...
#
#    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/curve_handle_type_selection.html
#    """
...
def curve_length(curve: nt.ProcNode[pt.CurveObject]) -> nt.ProcNode[float]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_length.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_of_point(point_index: nt.SocketOrVal[int] = 0) -> CurveOfPointResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_of_point.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return CurveOfPointResult(
        node.output_socket("curve_index"), node.output_socket("index_in_curve")
    )
...
def curve_bezier_segment(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_primitive_bezier_segment.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_circle(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve_primitive_circle.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_line(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve_primitive_line.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_line_from_direction(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_line_from_direction.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_quadrilateral(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_primitive_quadrilateral.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_bezier(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_quadratic_bezier.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_set_handles(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve_set_handles.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_spiral(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_spiral.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_spline_type(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve_spline_type.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_star(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_star.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return CurveStarResult(
        curve=res.output_socket("curve"),
        outer_points=res.output_socket("outer_points"),
    )
...
def curve_to_mesh(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_to_mesh.html
    """
    return nt.ProcNode.from_nodetype(
...
def curve_to_points(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/curve_to_points.html
    """
    inputs = {"Curve": curve}
    if mode == "COUNT":
        inputs["Count"] = count
    ...
    return CurveToPointsResult(
        points=res.output_socket("points"),
        tangent=res.output_socket("tangent"),
        normal=res.output_socket("normal"),
        rotation=res.output_socket("rotation"),
    )
...
def deform_curves_on_surface(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/deform_curves_on_surface.html
    """
    return nt.ProcNode.from_nodetype(
...
def delete_geometry(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/delete_geometry.html
    """
    return nt.ProcNode.from_nodetype(
...
def distribute_points_in_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/distribute_points_in_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def dual_mesh(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/dual_mesh.html
    """
    return nt.ProcNode.from_nodetype(
...
def duplicate_elements(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/duplicate_elements.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return DuplicateElementsResult(
        geometry=res.output_socket("Geometry"),
        duplicate_index=res.output_socket("Duplicate Index"),
    )
...
def edge_paths_to_curves(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/edge_paths_to_curves.html
    """
    return nt.ProcNode.from_nodetype(
...
def edge_paths_to_selection(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/edge_paths_to_selection.html
    """
    return nt.ProcNode.from_nodetype(
...
def edges_of_corner(corner_index: nt.SocketOrVal[int] = 0) -> EdgesOfCornerResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/edges_of_corner.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return EdgesOfCornerResult(
        next_edge_index=res.output_socket("next_edge_index"),
        previous_edge_index=res.output_socket("previous_edge_index"),
    )
...
def edges_of_vertex(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/edges_of_vertex.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return EdgesOfVertexResult(
        edge_index=res.output_socket("edge_index"),
        total=res.output_socket("total"),
    )
...
def edges_to_face_groups(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/edges_to_face_groups.html
    """
    return nt.ProcNode.from_nodetype(
...
def extrude_mesh(
    ...
    return ExtrudeMeshResult(
        node.output_socket("mesh"),
        node.output_socket("top"),
        node.output_socket("side"),
    )
...
def face_of_corner(corner_index: nt.SocketOrVal[int] = 0) -> FaceOfCornerResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/face_of_corner.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return FaceOfCornerResult(
        node.output_socket("face_index"), node.output_socket("index_in_face")
    )
...
def field_at_index(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/field_at_index.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
...
def field_on_domain(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/field_on_domain.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
...
def fill_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/fill_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def fillet_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/fillet_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def flip_faces(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/flip_faces.html
    """
    return nt.ProcNode.from_nodetype(
...
def get_named_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/get_named_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def grid_to_mesh(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/grid_to_mesh.html
    """
    return nt.ProcNode.from_nodetype(
...
def image_info(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/image_info.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return ImageInfoResult(
        node.output_socket("width"),
        node.output_socket("height"),
        node.output_socket("has_alpha"),
        node.output_socket("frame_count"),
        node.output_socket("fps"),
    )
...
def image_texture(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/image_texture.html
    """
    return nt.ProcNode.from_nodetype(
...
def index_of_nearest(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/index_of_nearest.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_active_camera() -> nt.ProcNode[pt.Object]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_active_camera.html
    """
...
def input_curve_handle_positions(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_curve_handle_positions.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputCurveHandlePositionsResult(
        node.output_socket("left"), node.output_socket("right")
    )
...
def input_curve_tilt() -> nt.ProcNode[float]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/input_curve_tilt.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_edge_smooth() -> nt.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input_edge_smooth.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_id() -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_id.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_image(image: Any = None) -> nt.ProcNode[pt.Image]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_image.html
    """
...
def input_index() -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_index.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_instance_rotation() -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_instance_rotation.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_instance_scale() -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/instances/input_instance_scale.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_material(material: Any = None) -> nt.ProcNode[pt.Material]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_material.html
    """
...
def input_material_index() -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_material_index.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_mesh_edge_angle() -> InputMeshEdgeAngleResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_edge_angle.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputMeshEdgeAngleResult(
        node.output_socket("unsigned_angle"), node.output_socket("signed_angle")
    )
...
def input_mesh_edge_neighbors() -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_edge_neighbors.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_mesh_edge_vertices() -> InputMeshEdgeVerticesResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_edge_vertices.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputMeshEdgeVerticesResult(
        node.output_socket("vertex_index_1"),
        node.output_socket("vertex_index_2"),
        node.output_socket("position_1"),
        node.output_socket("position_2"),
    )
...
def input_mesh_face_area() -> nt.ProcNode[float]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_face_area.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_mesh_face_is_planar(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input_mesh_face_is_planar.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_mesh_face_neighbors() -> InputMeshFaceNeighborsResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_face_neighbors.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return InputMeshFaceNeighborsResult(
        vertex_count=res.output_socket("vertex_count"),
        face_count=res.output_socket("face_count"),
    )
...
def input_mesh_island() -> InputMeshIslandResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_island.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputMeshIslandResult(
        node.output_socket("island_index"), node.output_socket("island_count")
    )
...
def input_mesh_vertex_neighbors() -> InputMeshVertexNeighborsResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_mesh_vertex_neighbors.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputMeshVertexNeighborsResult(
        node.output_socket("vertex_count"), node.output_socket("face_count")
    )
...
def input_named_attribute(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_named_attribute.html
    """
    ...
    return InputNamedAttributeResult(
        node.output_socket("attribute"), node.output_socket("exists")
    )
...
def input_named_layer_selection(name: nt.SocketOrVal[str] = "") -> nt.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_named_layer_selection.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_normal() -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_normal.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_position() -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_position.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_radius() -> nt.ProcNode[float]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/input_radius.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_scene_time() -> InputSceneTimeResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/input_scene_time.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return InputSceneTimeResult(
        seconds=node.output_socket("seconds"),
        frame=node.output_socket("frame"),
    )
...
def input_shade_smooth() -> nt.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input_shade_smooth.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_shortest_edge_paths(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/input_shortest_edge_paths.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return InputShortestEdgePathsResult(
        next_vertex_index=res.output_socket("next_vertex_index"),
        total_cost=res.output_socket("total_cost"),
    )
...
def input_spline_cyclic() -> nt.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input_spline_cyclic.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_spline_resolution() -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/input_spline_resolution.html
    """
    return nt.ProcNode.from_nodetype(
...
def input_tangent() -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input_tangent.html
    """
    return nt.ProcNode.from_nodetype(
...
def interpolate_curves(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/interpolate_curves.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return InterpolateCurvesResult(
        curves=res.output_socket("curves"),
        closest_index=res.output_socket("closest_index"),
        closest_weight=res.output_socket("closest_weight"),
    )
...
def is_viewport() -> nt.ProcNode[bool]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/is_viewport.html
    """
    return nt.ProcNode.from_nodetype(
...
def material_selection(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/material_selection.html
    """
    return nt.ProcNode.from_nodetype(
...
def merge_by_distance(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/merge_by_distance.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_boolean(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/mesh_boolean.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_circle(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_circle.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_cone(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_cone.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return MeshConeResult(
        mesh=res.output_socket("mesh"),
        uv_map=res.output_socket("uv_map"),
        top=res.output_socket("top"),
        bottom=res.output_socket("bottom"),
        side=res.output_socket("side"),
    )
...
def mesh_cube(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_cube.html
    """
    res = nt.ProcNode.from_nodetype(
...
def mesh_cylinder(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_cylinder.html
    """
    res = nt.ProcNode.from_nodetype(
...
def mesh_face_set_boundaries(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_face_set_boundaries.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/mesh_grid.html
    """
    res = nt.ProcNode.from_nodetype(
...
def mesh_icosphere(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh_ico_sphere.html
    """
    res = nt.ProcNode.from_nodetype(
...
def mesh_line(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_line.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_to_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_to_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_to_density_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/mesh_to_density_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_to_points(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_to_points.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_to_sdf_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/mesh_to_sdf_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_to_volume(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_to_volume.html
    """
    return nt.ProcNode.from_nodetype(
...
def mesh_uv_sphere(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/mesh_uv_sphere.html
    """
    res = nt.ProcNode.from_nodetype(
...
def object_info(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/object_info.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return ObjectInfoResult(
        geometry=res.output_socket("geometry"),
        transform=res.output_socket("transform"),
        location=res.output_socket("location"),
        rotation=res.output_socket("rotation"),
        scale=res.output_socket("scale"),
    )
...
def offset_corner_in_face(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/offset_corner_in_face.html
    """
    return nt.ProcNode.from_nodetype(
...
def offset_point_in_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/offset_point_in_curve.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return OffsetPointInCurveResult(
        is_valid_offset=res.output_socket("is_valid_offset"),
        point_index=res.output_socket("point_index"),
    )
...
def points_of_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/points_of_curve.html
    """
    res = nt.ProcNode.from_nodetype(
...
def points_to_sdf_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/points_to_sdf_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def proximity(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/proximity.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return ProximityResult(
        position=res.output_socket("position"),
        distance=res.output_socket("distance"),
        is_valid=res.output_socket("is_valid"),
    )
...
def raycast(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/raycast.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
    ...
    return RaycastResult(
        attribute=res.output_socket("attribute"),
        hit_distance=res.output_socket("hit_distance"),
        hit_normal=res.output_socket("hit_normal"),
        hit_position=res.output_socket("hit_position"),
        is_hit=res.output_socket("is_hit"),
    )
...
def remove_attribute(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/remove_attribute.html
    """
    return nt.ProcNode.from_nodetype(
...
def replace_material(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/replace_material.html
    """
    return nt.ProcNode.from_nodetype(
...
def reverse_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/reverse_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def sdf_grid_boolean(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/sdf_grid_boolean.html
    """
    return nt.ProcNode.from_nodetype(
...
def sample_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/sample_curve.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
...
def sample_grid_index(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/sample_grid_index.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
...
def sample_index(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/sample_index.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
...
def sample_nearest(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/sample_nearest.html
    """
    return nt.ProcNode.from_nodetype(
...
def sample_nearest_surface(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/sample_nearest_surface.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
...
def sample_uv_surface(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/sample_uv_surface.html
    """
    if data_type is None:
        data_type = RuntimeResolveDataType(
            [NodeDataType.BOOLEAN, NodeDataType.INT, NodeDataType.FLOAT],
...
def scale_elements(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/scale_elements.html
    """
    inputs = {
        "Geometry": geometry,
        "Selection": selection,
...
def self_object() -> nt.ProcNode[pt.Object]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/self_object.html
    """
    return nt.ProcNode.from_nodetype(
...
def separate_components(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/separate_components.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return SeparateComponentsResult(
        node.output_socket("mesh"),
        node.output_socket("curve"),
        node.output_socket("point_cloud"),
        node.output_socket("volume"),
        node.output_socket("instances"),
    )
...
def separate_geometry(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/separate_geometry.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return SeparateGeometryResult(
        selection=res.output_socket("selection"),
        inverted=res.output_socket("inverted"),
    )
...
def set_curve_handle_positions(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_curve_handle_positions.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_curve_normal(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_curve_normal.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_curve_radius(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_curve_radius.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_curve_tilt(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/set_curve_tilt.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_id(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_id.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_material(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/set_material.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_material_index(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/set_material_index.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_point_radius(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_point_radius.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_position(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/set_position.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_shade_smooth(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/set_shade_smooth.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_spline_cyclic(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/set_spline_cyclic.html
    """
    return nt.ProcNode.from_nodetype(
...
def set_spline_resolution(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/set_spline_resolution.html
    """
    return nt.ProcNode.from_nodetype(
...
def sort_elements(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/sort_elements.html
    """
    return nt.ProcNode.from_nodetype(
...
def spline_length() -> SplineLengthResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/spline_length.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return SplineLengthResult(
        node.output_socket("length"), node.output_socket("point_count")
    )
...
def spline_parameter() -> SplineParameterResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/spline_parameter.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return SplineParameterResult(
        node.output_socket("factor"),
        node.output_socket("length"),
        node.output_socket("index"),
    )
...
def split_edges(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/split_edges.html
    """
    return nt.ProcNode.from_nodetype(
...
def split_to_instances(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/split_to_instances.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return SplitToInstancesResult(
        instances=res.output_socket("instances"),
        group_id=res.output_socket("group_id"),
    )
...
def store_named_grid(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/store_named_grid.html
    """
    return nt.ProcNode.from_nodetype(
...
def string_join(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/string_join.html
    """
    return nt.ProcNode.from_nodetype(
...
def string_to_curves(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/string_to_curves.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return StringToCurvesResult(
        curve_instances=res.output_socket("curve_instances"),
        line=res.output_socket("line"),
        pivot_point=res.output_socket("pivot_point"),
    )
...
def subdivide_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/subdivide_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def subdivide_mesh(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/subdivide_mesh.html
    """
    return nt.ProcNode.from_nodetype(
...
def subdivision_surface(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/subdivision_surface.html
    """
    return nt.ProcNode.from_nodetype(
...
def tool3_d_cursor() -> Tool3DCursorResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/tool3_d_cursor.html
    """
    ...
    return Tool3DCursorResult(node.output_socket("location"), node.output_socket("rotation"))
...
def tool_active_element(domain: TDomain = "POINT") -> ToolActiveElementResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/tool_active_element.html
    """
    node = t.ProcNode.from_nodetype(
    ...
    return ToolActiveElementResult(node.output_socket("index"), node.output_socket("exists"))
...
def tool_face_set() -> ToolFaceSetResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/tool_face_set.html
    """
    node = t.ProcNode.from_nodetype(
    ...
    return ToolFaceSetResult(node.output_socket("face_set"), node.output_socket("exists"))
...
def tool_mouse_position() -> ToolMousePositionResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/tool_mouse_position.html
    """
    node = t.ProcNode.from_nodetype(
    ...
    return ToolMousePositionResult(
        node.output_socket("mouse_x"), node.output_socket("mouse_y"), node.output_socket("region_width"), node.output_socket("region_height")
    )
...
def tool_selection() -> t.ProcNode:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/tool_selection.html
    """
    return t.ProcNode.from_nodetype(
...
def tool_set_face_set(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/tool_set_face_set.html
    """
    return t.ProcNode.from_nodetype(
...
def tool_set_selection(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/geometry/tool_set_selection.html
    """
    return t.ProcNode.from_nodetype(
...
def transform(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/transform.html
    """
    return nt.ProcNode.from_nodetype(
...
def triangulate(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/triangulate.html
    """
    return nt.ProcNode.from_nodetype(
...
def trim_curve(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/curve/trim_curve.html
    """
    return nt.ProcNode.from_nodetype(
...
def uv_pack_islands(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/uv_pack_islands.html
    """
    return nt.ProcNode.from_nodetype(
...
def uv_unwrap(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/uv_unwrap.html
    """
    return nt.ProcNode.from_nodetype(
...
def vertex_of_corner(corner_index: nt.SocketOrVal[int] = 0) -> nt.ProcNode[int]:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/vertex_of_corner.html
    """
    return nt.ProcNode.from_nodetype(
...
def viewport_transform() -> ViewportTransformResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/input/viewport_transform.html
    """
    node = nt.ProcNode.from_nodetype(
    ...
    return ViewportTransformResult(
        node.output_socket("projection"),
        node.output_socket("view"),
        node.output_socket("is_orthographic"),
    )
...
def volume_cube(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/mesh/volume_cube.html
    """
    return nt.ProcNode.from_nodetype(
...
def volume_to_mesh(
    ...
    See: https://docs.blender.org/manual/en/4.2/modeling/geometry_nodes/volume/volume_to_mesh.html
    """
    return nt.ProcNode.from_nodetype(
