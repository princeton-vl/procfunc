...
def add_shader(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/add_shader.html
    """
...
def ambient_occlusion(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/input/ambient_occlusion.html
    """
    ...
    return AmbientOcclusionResult(
        color=res.output_socket("color"), ao=res.output_socket("ao")
    )
...
def attribute(
    ...
    return AttributeResult(
        color=res.output_socket("color"),
        vector=res.output_socket("vector"),
        fac=res.output_socket("fac"),
        alpha=res.output_socket("alpha"),
    )
...
def bright_contrast(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/bright_contrast.html
    """
    return nt.ProcNode.from_nodetype(
...
def anisotropic_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/bsdf_anisotropic.html
    """
...
def diffuse_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_diffuse.html
    """
...
def glass_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_glass.html
    """
...
def hair_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_hair.html
    """
    return nt.ProcNode.from_nodetype(
...
def principled_hair_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_hair_principled.html
    """
    return nt.ProcNode.from_nodetype(
...
def principled_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_principled.html
    """
...
def ray_portal_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_ray_portal.html
    """
    return nt.ProcNode.from_nodetype(
...
def refraction_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_refraction.html
    """
...
def sheen_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_sheen.html
    """
...
def toon_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_toon.html
    """
...
def translucent_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_translucent.html
    """
...
def transparent_bsdf(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/bsdf_transparent.html
    """
    return nt.ProcNode.from_nodetype(
...
def camera_data() -> CameraDataResult:
    ...
    return CameraDataResult(
        view_vector=res.output_socket("view_vector"),
        view_z_depth=res.output_socket("view_z_depth"),
        view_distance=res.output_socket("view_distance"),
    )
...
def eevee_specular(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/eevee_specular.html
    """
    return nt.ProcNode.from_nodetype(
...
def hair_info() -> HairInfoResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/hair_info.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return HairInfoResult(
        is_strand=res.output_socket("is_strand"),
        intercept=res.output_socket("intercept"),
        length=res.output_socket("length"),
        thickness=res.output_socket("thickness"),
        tangent_normal=res.output_socket("tangent_normal"),
        random=res.output_socket("random"),
    )
...
def invert(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/color/invert.html
    """
    return nt.ProcNode.from_nodetype(
...
def layer_weight(
    ...
    return LayerWeightResult(
        fresnel=res.output_socket("fresnel"),
        facing=res.output_socket("facing"),
    )
...
def light_falloff(
    ...
    return LightFalloffResult(
        quadratic=res.output_socket("quadratic"),
        linear=res.output_socket("linear"),
        constant=res.output_socket("constant"),
    )
...
def light_path() -> LightPathResult:
    ...
    return LightPathResult(
        is_camera_ray=res.output_socket("is_camera_ray"),
        is_shadow_ray=res.output_socket("is_shadow_ray"),
        is_diffuse_ray=res.output_socket("is_diffuse_ray"),
        is_glossy_ray=res.output_socket("is_glossy_ray"),
        is_singular_ray=res.output_socket("is_singular_ray"),
        is_reflection_ray=res.output_socket("is_reflection_ray"),
        is_transmission_ray=res.output_socket("is_transmission_ray"),
        ray_length=res.output_socket("ray_length"),
        ray_depth=res.output_socket("ray_depth"),
        diffuse_depth=res.output_socket("diffuse_depth"),
        glossy_depth=res.output_socket("glossy_depth"),
        transparent_depth=res.output_socket("transparent_depth"),
        transmission_depth=res.output_socket("transmission_depth"),
    )
...
def mix_shader(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/mix_shader.html
    """
    return nt.ProcNode.from_nodetype(
...
def object_info() -> ObjectInfoResult:
    ...
    return ObjectInfoResult(
        ...
        color=res.output_socket("color"),
        alpha=res.output_socket("alpha"),
        object_index=res.output_socket("object_index"),
        material_index=res.output_socket("material_index"),
        random=res.output_socket("random"),
    )
...
def output_aov(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/output_aov.html
    """
...
def output_light(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/output/output_light.html
    """
...
def output_line_style(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/output_line_style.html
    """
...
def output_material(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/output_material.html
    """
...
def output_world(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/output/output_world.html
    """
    return t.ProcNode.from_nodetype(
...
def particle_info() -> ParticleInfoResult:
    ...
    return ParticleInfoResult(
        index=res.output_socket("index"),
        random=res.output_socket("random"),
        age=res.output_socket("age"),
        lifetime=res.output_socket("lifetime"),
        location=res.output_socket("location"),
        size=res.output_socket("size"),
        velocity=res.output_socket("velocity"),
        angular_velocity=res.output_socket("angular_velocity"),
    )
...
def point_info() -> PointInfoResult:
    ...
    return PointInfoResult(
        ...
        radius=res.output_socket("radius"),
        random=res.output_socket("random"),
    )
...
def script(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/script.html
    """
    return nt.ProcNode.from_nodetype(
...
def squeeze(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/squeeze.html
    """
    return nt.ProcNode.from_nodetype(
...
def subsurface_scattering(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/shader/subsurface_scattering.html
    """
...
def brick(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/brick.html
    """
    if vector is None:
...
def checker(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/checker.html
    """
    if vector is None:
...
def coord(from_instancer: bool = False, object: Any = None) -> CoordResult:
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/coord.html
    """
    res = nt.ProcNode.from_nodetype(
    ...
    return CoordResult(
        generated=res.output_socket("generated"),
        normal=res.output_socket("normal"),
        uv=res.output_socket("uv"),
        object=res.output_socket("object"),
        camera=res.output_socket("camera"),
        window=res.output_socket("window"),
    )
...
def geometry() -> GeometryResult:
    ...
    return GeometryResult(
        ...
        true_normal=res.output_socket("true_normal"),
        incoming=res.output_socket("incoming"),
        parametric=res.output_socket("parametric"),
        backfacing=res.output_socket("backfacing"),
        pointiness=res.output_socket("pointiness"),
        random_per_island=res.output_socket("random_per_island"),
    )
...
def environment(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/environment.html
    """
    if vector is None:
...
def gradient(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/gradient.html
    """
    if vector is None:
...
def ies(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/ies.html
    """
    if vector is None:
...
def image(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/image.html
    """
    if vector is None:
...
def magic(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/magic.html
    """
    if vector is None:
...
def musgrave(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/musgrave.html
    """
    if vector is None:
...
def noise(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/noise.html
    """
    ...
    extra_args_modes = ["RIDGED_MULTIFRACTAL", "HYBRID_MULTIFRACTAL"]
    if offset != 0.0:
...
def point_density(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/point_density.html
    """
    if vector is None:
    ...
    return PointDensityResult(
        color=res.output_socket("color"),
        density=res.output_socket("density"),
    )
...
def sky(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/sky.html
    """
    return nt.ProcNode.from_nodetype(
...
def voronoi(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/voronoi.html
    """
    ...
    w = res.output_socket("w") if voronoi_dimensions == "4D" else None
...
def wave(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/wave.html
    """
    if vector is None:
...
def white_noise(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/white_noise.html
    """
...
def uv_along_stroke(use_tips: bool = False) -> nt.ProcNode[pt.Vector]:
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/uv_along_stroke.html
    """
    return nt.ProcNode.from_nodetype(
...
def color_ramp(
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/input/val_to_rgb.html
    """
...
def vertex_color(layer_name: str = "") -> nt.ProcNode[pt.Color]:
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/vertex_color.html
    """
    return nt.ProcNode.from_nodetype(
...
def wavelength(wavelength: nt.SocketOrVal[float] = 500.0) -> nt.ProcNode[pt.Color]:
    ...
    See: https://docs.blender.org/manual/en/4.2/render/shader_nodes/texture/wavelength.html
    """
    return nt.ProcNode.from_nodetype(
