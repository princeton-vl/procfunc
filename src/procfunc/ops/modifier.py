...
def _boolean(
    ...
    **kwargs: Unpack[BooleanArgs],
):
    params = BooleanArgs(**kwargs)
    ...
    kwargs["solver"] = "FAST" if params.fast else "EXACT"
    kwargs["use_hole_tolerant"] = params.hole_tolerant
    kwargs["use_self"] = params.self_intersect
...
def boolean_difference(
    ...
    **kwargs: Unpack[BooleanArgs],
    ...
    return _boolean(mutates_obj, target, operation="DIFFERENCE", **kwargs)
...
def boolean_intersect(
    ...
    **kwargs: Unpack[BooleanArgs],
    ...
    return _boolean(mutates_obj, target, operation="INTERSECT", **kwargs)
...
def boolean_union(
    ...
    **kwargs: Unpack[BooleanArgs],
    ...
    return _boolean(mutates_obj, target, operation="UNION", **kwargs)
