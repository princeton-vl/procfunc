...
class Asset(Generic[T]):
    ...
    def add_dependency(self, dependency: "Asset"):
        raise NotImplementedError("Subclasses of Asset must implement add_dependency()")
...
World: TypeAlias = bpy.types.World
...
class Material:
    ...
    _dependencies: list = field(default_factory=list, init=False, repr=False)
