...
- `sky_texture_nishita` uses `None` sentinels for sun elevation, intensity, rotation, and size; explicit values require `sun_disc=True`, while omitted values resolve to Blender's defaults
