...
BGYM="--backend bgym --blender_path blendergym/infinigen/blender/blender --render_script blendergym/system/blender_base/pipeline_render_script.py"

PF_PARAMEDIT="--backend pf --bench_data outputs/bench_data_geo_pf --prompt_file prompts/geo_simple/pf_paramedit.txt --rounds 4 "
BGYM_PARAMEDIT="--backend bgym --bench_data outputs/bench_data_geo --prompt_file prompts/geo_simple/ifg_paramedit.txt $BGYM --rounds 4"
PF_FROMSCRATCH="--backend pf --bench_data outputs/bench_data_geo_pf_fromscratch --prompt_file prompts/geo_simple/pf_fromscratch.txt --rounds 8"
BGYM_FROMSCRATCH="--backend bgym --bench_data outputs/bench_data_geo_ifg_fromscratch --prompt_file prompts/geo_simple/ifg_fromscratch.txt $BGYM --rounds 8"
...
uv run python scripts/evaluate_results.py outputs/exp_geo_pf_paramedit_gemini-2.5-flash/* --bench_data outputs/bench_data_geo_pf
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_paramedit_gemini-2.5-flash/* --bench_data outputs/bench_data_geo
uv run python scripts/evaluate_results.py outputs/exp_geo_pf_paramedit_gemini-2.5-pro/* --bench_data outputs/bench_data_geo_pf
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_paramedit_gemini-2.5-pro/* --bench_data outputs/bench_data_geo
uv run python scripts/evaluate_results.py outputs/exp_geo_pf_paramedit_gpt-5-mini/* --bench_data outputs/bench_data_geo_pf
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_paramedit_gpt-5-mini/* --bench_data outputs/bench_data_geo
uv run python scripts/evaluate_results.py outputs/exp_geo_pf_paramedit_gpt-5.2/* --bench_data outputs/bench_data_geo_pf
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_paramedit_gpt-5.2/* --bench_data outputs/bench_data_geo

for f in outputs/*geo*paramedit*/0/overall_scores.tsv; do echo "$f"; cat "$f"; echo; echo; done > outputs/tab1_geo_paramedit.tsv

uv run python scripts/evaluate_results.py outputs/exp_geo_pf_fromscratch_gemini-2.5-pro_nodocs/* --bench_data outputs/bench_data_geo_pf_fromscratch
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_fromscratch_gemini-2.5-pro_nodocs/* --bench_data outputs/bench_data_geo_ifg_fromscratch
uv run python scripts/evaluate_results.py outputs/exp_geo_pf_fromscratch_gemini-2.5-pro/* --bench_data outputs/bench_data_geo_pf_fromscratch
uv run python scripts/evaluate_results.py outputs/exp_geo_ifg_fromscratch_gemini-2.5-pro/* --bench_data outputs/bench_data_geo_ifg_fromscratch
