...
# PF fromscratch
$METHOD $PF_FROMSCRATCH --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_pf_fromscratch_gemini-2.5-pro_nodocs/0
$METHOD $PF_FROMSCRATCH --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_pf_fromscratch_gemini-2.5-pro/0 $PF_DOCS
$METHOD $PF_FROMSCRATCH --model gpt-5.2          --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_pf_fromscratch_gpt-5.2/0 $PF_DOCS

# IFG fromscratch
$METHOD $BGYM_FROMSCRATCH --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_ifg_fromscratch_gemini-2.5-pro_nodocs/0
$METHOD $BGYM_FROMSCRATCH --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_ifg_fromscratch_gemini-2.5-pro/0 $BGYM_DOCS
$METHOD $BGYM_FROMSCRATCH --model gpt-5.2          --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_ifg_fromscratch_gpt-5.2/0 $BGYM_DOCS
