...
# PF paramedit
$METHOD $PF_PARAMEDIT --model gemini-2.5-flash --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_pf_paramedit_gemini-2.5-flash/0/
$METHOD $PF_PARAMEDIT --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_pf_paramedit_gemini-2.5-pro/0
$METHOD $PF_PARAMEDIT --model gpt-5-mini       --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_pf_paramedit_gpt-5-mini/0
$METHOD $PF_PARAMEDIT --model gpt-5.2          --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_pf_paramedit_gpt-5.2/0

# IFG paramedit
$METHOD $BGYM_PARAMEDIT --model gemini-2.5-flash --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_ifg_paramedit_gemini-2.5-flash/0
$METHOD $BGYM_PARAMEDIT --model gemini-2.5-pro   --api_key_txt credentials/gemini_api.txt --output_dir outputs/exp_ifg_paramedit_gemini-2.5-pro/0
$METHOD $BGYM_PARAMEDIT --model gpt-5-mini       --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_ifg_paramedit_gpt-5-mini/0
$METHOD $BGYM_PARAMEDIT --model gpt-5.2          --api_key_txt credentials/openai_api.txt --output_dir outputs/exp_ifg_paramedit_gpt-5.2/0
